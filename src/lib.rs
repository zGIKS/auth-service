...
#[openapi(
    paths(
        ...
        iam::authentication::interfaces::rest::controllers::authentication_controller::login
    ),
    components(
        schemas(
            ...
            iam::authentication::interfaces::rest::resources::login_resource::LoginResource,
            iam::authentication::interfaces::rest::resources::login_resource::TokenResponse
        )
    ),
    tags(
